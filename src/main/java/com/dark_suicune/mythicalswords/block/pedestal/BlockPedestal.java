...
import com.dark_suicune.mythicalswords.block.BlockBase;
import com.dark_suicune.mythicalswords.block.BlockTileEntity;
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
		if (!world.isRemote) {
			...
			if (!player.isSneaking()) {
				...
				if (stack != null) {
					String localized = MythicalSwords.proxy.localize(stack.getUnlocalizedName() + ".name");
