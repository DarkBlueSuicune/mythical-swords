...
public class ItemLightningSword extends net.minecraft.item.ItemSword implements ItemModelProvider {
	
	private String name;

	public ItemLightningSword(ToolMaterial material, String name) {
		super(material);
	...
	@Override
	public ItemLightningSword setCreativeTab(CreativeTabs tab) {
